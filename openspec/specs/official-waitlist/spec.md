...
Defines the official primary-sale waitlist for sold-out ticket types, including waitlist membership, FIFO purchase entitlement grants, entitlement lifecycle, user notifications, and the explicit exclusion of resale marketplace behavior.
