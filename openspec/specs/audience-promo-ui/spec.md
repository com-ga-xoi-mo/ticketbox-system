# Spec: audience-promo-ui

## Purpose
TBD: Defines the UI requirements for applying promotion codes and displaying pricing breakdowns in the audience web app checkout flow.
