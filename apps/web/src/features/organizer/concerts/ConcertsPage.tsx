    ...
    <div className="flex h-full flex-col gap-2 overflow-hidden p-4 md:px-8 md:py-3">
      ...
      {concerts.length === 0 ? (
        <div className="flex-1 overflow-y-auto mt-4">
          <ConcertEmptyState canCreate={true} onCreateClick={handleOpenCreate} />
        </div>
      ) : (
            ...
            {selectedConcert && (
              <div className="w-[400px] shrink-0">
                <ConcertDetailPanel
                  ...
                  onEdit={() => navigate(`/organizer/concerts/${selectedConcert.id}/edit`)}
                  ...
                  extraContent={<ArtistBioPanel concertId={selectedConcert.id} role="ORGANIZER" />}
                />
              </div>
            )}
          </div>
