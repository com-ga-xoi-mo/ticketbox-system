...
function renderPage() {
  return render(
    <MemoryRouter initialEntries={[`/admin/concerts/${CONCERT_ID}/edit`]}>
      <Routes><Route path="/admin/concerts/:id/edit" element={<ConcertEditPage />} /></Routes>
    </MemoryRouter>,
  );
}

describe('admin ConcertEditPage waiting room integration', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('renders the shared section with the loaded concert ID without submitting the parent form', async () => {
    renderPage();
