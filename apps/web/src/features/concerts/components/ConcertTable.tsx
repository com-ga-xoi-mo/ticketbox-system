            ...
            return (
              ...
              >
                ...
                <TableCell className="pl-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <div
                        className={cn(
                          'block truncate text-sm font-bold leading-tight text-on-surface transition-colors',
                ...
                <TableCell>
                  ...
                  <div className="mt-0.5 font-mono text-[10px] text-on-surface-variant/50">
                    → {formatDateTime(concert.endsAt)}
                  </div>
                </TableCell>
