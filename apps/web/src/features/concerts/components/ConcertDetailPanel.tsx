...
import { usePublishConcertMutation, useCancelConcertMutation } from '../hooks';
...
export function ConcertDetailPanel({
  ...
  const handlePublish = async () => {
    if (confirm(`Are you sure you want to publish "${concert.title}"?`)) {
      publishMutation.mutate(concert.id);
    }
  };
      ...
      <div className="flex-1 overflow-y-auto relative">
        ...
        <div className="relative min-h-[240px] w-full bg-gradient-to-br from-primary/20 via-surface-container to-tertiary/10">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-6 pb-5 pt-10">
            ...
            <h4 className="break-words font-display text-xl font-bold leading-tight text-white drop-shadow">
              {concert.title}
            </h4>
        ...
        <div className="flex gap-2.5">
          {isDraft && (
            ...
            >
              ...
              {publishMutation.isPending ? 'Publishing…' : 'Publish concert'}
            </Button>
          )}
          ...
          {canModify && (
            ...
            >
              ...
              {cancelMutation.isPending ? 'Cancelling…' : 'Cancel concert'}
            </Button>
          )}
        </div>
